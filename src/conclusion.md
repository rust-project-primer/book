...
shifts responsibility for certain correctness principles, such as memory
safety, from the developers and maintainers to the compiler. In the long term,
it is cheaper and more scalable to have this correctness validated by a machine
...
certain project-level correctness principles from the developers and
maintainers of Rust projects to machines. These principles include correct
