...
A large part of Rust's popularity is perhaps not due to the language features,
but to the quality of the tooling around it. Cargo is the build system that the
Rust language uses, and it is excellent.
