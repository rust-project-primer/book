...
them, feel free to use an adblocker (such as [uBlock Origin][ublock], which will
block Plausible. You may also print and use a PDF version of this book, or clone
the repository and build and view the book locally.
