...
This book uses [mdBook][mdbook], a tool that is commonly used by the Rust ecosystem
to write documentation in the style of books. It makes some modifications to the
default mdBook configuration:
...
- The default font for diagrams is [Routed Gothic](routed-gothic), a recreation of the classic [Gorton font used in technical drawings and machine labels][gorton].
